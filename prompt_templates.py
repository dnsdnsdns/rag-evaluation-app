...
evaluation_templates = {
    ...
    "faithfulness": {
        ...
        # Context and Answer will be displayed separately
    ...
    "context_relevance": {
        ...
        # Query and Contexts will be displayed separately
        "required_attributes": ["retrieved_contexts", "query", "retrieved_contexts_full", "context"], # Keep 'context' if used internally, otherwise remove
        "rating_scale": ["Ja", "Nein"]
    },
    "handoff": {
    ...
    "quality_pairwise": {
        ...
        # Query and Answers A/B will be displayed separately
    ...
    "multiturn_answer_correctness": {
        ...
        # History, Reference, and Answer will be displayed separately
    ...
    "multiturn_answer_relevance": {
        ...
        # History, Query, and Answer will be displayed separately
    ...
    "multiturn_context_relevance": {
        ...
        # History, Query, and Contexts will be displayed separately
        "required_attributes": ["retrieved_contexts", "query", "history", "retrieved_contexts_full", "context"], # Keep 'context' if used internally
        "rating_scale": ["Ja", "Nein"]
    },
    "multiturn_faithfulness": {
        ...
        # History, Context, and Answer will be displayed separately
    ...
    "multiturn_handoff": {
        ...
        # History and Answer will be displayed separately
    ...
    "multiturn_quality_pairwise": {
        ...
        # History, Query, and Answers A/B will be displayed separately
        "required_attributes": ["answer_a", "answer_b", "query", "history"],
        "rating_scale": ["A", "B", "Unentschieden"]
    }
}

# General intro prompt remains the same
